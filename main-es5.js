...
var AppComponent = /** @class */ (function () {
    function AppComponent(sim_service, dialog) {
        this.dialog = dialog;
        this.ops = ['Add'];
        this.qtd_bits = [];
        this.op = undefined;
    ...
    AppComponent.prototype.openDialogRV = function () {
        this.dialog.open(_dialog_detailed_rv__WEBPACK_IMPORTED_MODULE_6__["DialogOverviewDetailedRV"]);
    };
    AppComponent.prototype.openDialogAbout = function () {
...
var DialogOverviewDetailedRV = /** @class */ (function () {
    function DialogOverviewDetailedRV(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    DialogOverviewDetailedRV.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    DialogOverviewDetailedRV.prototype.onClick = function () {
        return true;
    };
    DialogOverviewDetailedRV.ctorParameters = function () { return [
    ...
    return DialogOverviewDetailedRV;
}());
...
var DialogOverviewDetailed = /** @class */ (function () {
    function DialogOverviewDetailed(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    DialogOverviewDetailed.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    DialogOverviewDetailed.prototype.onClick = function () {
        return true;
    };
    DialogOverviewDetailed.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
    ]; };
